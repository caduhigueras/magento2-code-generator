...
class UiFolderStructure
{
    ...
    public function generateDataProviderFile($vendorNamespaceArr, $appFolderPath, $entityName, $dbColumns)
    {
        ...
        if (!$this->filesystemIo->fileExists($actionsFile)){
            ...
            $contents .= '     * @var' . PHP_EOL;
            $contents .= '     */' . PHP_EOL;
            $contents .= '    protected $fieldsCollection;' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            $contents .= '    /**' . PHP_EOL;
            ...
            $contents .= '     */' . PHP_EOL;
            $contents .= '    protected $json;' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            $contents .= '    /**' . PHP_EOL;
            $contents .= '     * @var RequestInterface' . PHP_EOL;
            $contents .= '     */' . PHP_EOL;
            $contents .= '    protected $request;' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            $contents .= '    /**' . PHP_EOL;
            ...
            $contents .= '     * @var array' . PHP_EOL;
            $contents .= '     */' . PHP_EOL;
            $contents .= '    protected $loadedData;' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            ...
            $contents .= '    }' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            $contents .= '    public function prepareMeta(array $meta)' . PHP_EOL;
            $contents .= '    {' . PHP_EOL;
            $contents .= '        return $meta;' . PHP_EOL;
            $contents .= '    }' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            $contents .= '    public function getData()' . PHP_EOL;
            $contents .= '    {' . PHP_EOL;
    ...
    public function generateListingActionFile($vendorNamespaceArr, $uiListingFolder, $entityName, $frontName)
    {
        ...
        if (!$this->filesystemIo->fileExists($actionsFile)){
            ...
            $contents .= '' . PHP_EOL;
            $contents .= '    /** @var UrlInterface */' . PHP_EOL;
            $contents .= '    protected $urlBuilder;' . PHP_EOL;
            $contents .= '' . PHP_EOL;
            $contents .= '    /**' . PHP_EOL;
            ...
            $contents .= '     */' . PHP_EOL;
            $contents .= '    public function prepareDataSource(array $dataSource)' . PHP_EOL;
            $contents .= '    {' . PHP_EOL;
